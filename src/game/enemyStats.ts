...
export const ENEMY_STATS: Record<EnemyType, EnemyStats> = {
    acid_slug: {
        ...
        accuracy: 65,
        armor: 1,
        color: "#a4f018",  // Bright acidic lime
        aggroRange: 7,
        attackCooldown: 2000,
        size: 1.0,
    ...
    baby_kraken: {
        ...
        accuracy: 65,
        armor: 2,
        color: "#a040e8",      // Bright vivid purple
        aggroRange: 12,
        attackCooldown: 3000,
        size: 2.5,             // Large
    ...
    bloated_corpse: {
        ...
        accuracy: 55,
        armor: 1,
        color: "#70a830",      // Sickly undead green
        aggroRange: 8,
        attackCooldown: 2400,
    ...
    chittering_crabling: {
        ...
        accuracy: 60,
        armor: 2,              // Hard shell
        color: "#e84010",      // Vivid orange-red shell
        aggroRange: 6,
    ...
    corrupt_druid: {
        ...
        accuracy: 70,
        armor: 0,
        color: "#206808",      // Dark saturated green
        aggroRange: 10,
    ...
    giant_amoeba: {
        ...
        accuracy: 55,
        armor: 0,
        color: "#08d858",  // Vivid sea green - translucent blob
        aggroRange: 6,
        attackCooldown: 2200,
    ...
    magma_imp: {
        ...
        accuracy: 75,
        armor: 0,
        color: "#ff3800",      // Bright orange-red (magma)
        aggroRange: 10,
    ...
    necromancer: {
        ...
        accuracy: 65,
        armor: 0,
        color: "#420042",          // Dark vivid purple
        aggroRange: 10,
        attackCooldown: 2500,
    ...
    undead_knight: {
        ...
        accuracy: 65,
        armor: 2,          // Heavy armor
        color: "#0c3870",  // Vivid dark steel blue
        aggroRange: 8,
