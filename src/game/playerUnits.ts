...
export const UNIT_DATA: Record<number, UnitData> = {
    1: { name: "Barbarian", class: "Barbarian", hp: 33, maxHp: 33, mana: 15, maxMana: 15, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.highlandDefense, SKILLS.cleave, SKILLS.bloodMark, SKILLS.warcry, SKILLS.intimidate, SKILLS.stunningBlow, SKILLS.summonAncestor, SKILLS.defiance], items: [], range: 1.95, attackCooldown: 2000, baseCrit: 3 },
    2: { name: "Paladin", class: "Paladin", hp: 32, maxHp: 32, mana: 19, maxMana: 19, damage: [1, 4], accuracy: 65, armor: 0, skills: [SKILLS.raiseShield, SKILLS.smite, SKILLS.holyStrike, SKILLS.vanquishingLight, SKILLS.divineLattice, SKILLS.layOnHands, SKILLS.sanctuary], items: [], range: 1.7, attackCooldown: 2500 },
    3: { name: "Thief", class: "Thief", hp: 20, maxHp: 20, mana: 17, maxMana: 17, damage: [1, 4], accuracy: 75, armor: 0, skills: [SKILLS.poisonDagger, SKILLS.dodge, SKILLS.caltrops, SKILLS.targetArm, SKILLS.targetLegs, SKILLS.smokeBomb, SKILLS.targetHead], items: [], attackCooldown: 1500, baseCrit: 5 },
    4: { name: "Wizard", class: "Wizard", hp: 17, maxHp: 17, mana: 45, maxMana: 45, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.fireBolt, SKILLS.bodySwap, SKILLS.glacialWhorl, SKILLS.fireball, SKILLS.teleportOther, SKILLS.energyShield, SKILLS.channeling, SKILLS.wallOfFire, SKILLS.chainLightning, SKILLS.magicWave], items: [], attackCooldown: 3000, baseCrit: 2 },
    5: { name: "Monk", class: "Monk", hp: 25, maxHp: 25, mana: 17, maxMana: 17, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.dimMak, SKILLS.pangolinStance, SKILLS.qiFocus, SKILLS.forcePush, SKILLS.fivePointPalm, SKILLS.flurryOfFists, SKILLS.sunStance, SKILLS.flyingKick, SKILLS.wellOfGravity], items: [], attackCooldown: 1800 },
    6: { name: "Cleric", class: "Cleric", hp: 24, maxHp: 24, mana: 37, maxMana: 37, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.cleanse, SKILLS.heal, SKILLS.restoration, SKILLS.thunder, SKILLS.vishasEyes, SKILLS.elorasGrasp, SKILLS.turnUndead, SKILLS.holyCross, SKILLS.massHeal, SKILLS.ankh], items: [], attackCooldown: 2500 },
    7: { name: "Ancestor", class: "Ancestor", hp: 40, maxHp: 40, mana: 0, maxMana: 0, damage: [2, 5], accuracy: 68, armor: 1, skills: [], items: [], range: 1.8, attackCooldown: 2400, size: 1.08, baseCrit: 2 },
