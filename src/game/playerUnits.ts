...
export const UNIT_DATA: Record<number, UnitData> = {
    1: { name: "Barbarian", class: "Barbarian", hp: 33, maxHp: 33, mana: 15, maxMana: 15, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.warcry, SKILLS.defiance, SKILLS.stunningBlow, SKILLS.bloodMark, SKILLS.summonAncestor, SKILLS.highlandDefense], items: [], range: 1.95, attackCooldown: 2000, baseCrit: 3 },
    ...
    5: { name: "Monk", class: "Monk", hp: 25, maxHp: 25, mana: 17, maxMana: 17, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.flurryOfFists, SKILLS.forcePush, SKILLS.wellOfGravity, SKILLS.qiFocus, SKILLS.sunStance, SKILLS.pangolinStance], items: [], attackCooldown: 1800 },
