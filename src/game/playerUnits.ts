...
export const UNIT_DATA: Record<number, UnitData> = {
    1: { name: "Barbarian", class: "Barbarian", hp: 38, maxHp: 38, mana: 15, maxMana: 15, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.warcry, SKILLS.defiance, SKILLS.stunningBlow, SKILLS.summonAncestor, SKILLS.highlandDefense], items: [], attackCooldown: 2000, baseCrit: 3 },
    2: { name: "Paladin", class: "Paladin", hp: 35, maxHp: 35, mana: 20, maxMana: 20, damage: [1, 4], accuracy: 65, armor: 0, skills: [SKILLS.raiseShield, SKILLS.divineLattice, SKILLS.sanctuary, SKILLS.holyStrike, SKILLS.vanquishingLight], items: [], attackCooldown: 2500 },
    3: { name: "Thief", class: "Thief", hp: 22, maxHp: 22, mana: 18, maxMana: 18, damage: [1, 4], accuracy: 75, armor: 0, skills: [SKILLS.poisonDagger, SKILLS.targetHead, SKILLS.targetArm, SKILLS.targetLegs, SKILLS.caltrops, SKILLS.dodge], items: [], attackCooldown: 1500, baseCrit: 5 },
    4: { name: "Wizard", class: "Wizard", hp: 18, maxHp: 18, mana: 50, maxMana: 50, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.fireball, SKILLS.chainLightning, SKILLS.magicWave, SKILLS.glacialWhorl, SKILLS.energyShield, SKILLS.bodySwap], items: [], attackCooldown: 3000, baseCrit: 2 },
    5: { name: "Monk", class: "Monk", hp: 28, maxHp: 28, mana: 18, maxMana: 18, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.flurryOfFists, SKILLS.forcePush, SKILLS.qiFocus, SKILLS.sunStance, SKILLS.pangolinStance], items: [], attackCooldown: 1800 },
    6: { name: "Cleric", class: "Cleric", hp: 26, maxHp: 26, mana: 40, maxMana: 40, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.heal, SKILLS.cleanse, SKILLS.thunder, SKILLS.holyCross, SKILLS.vishasEyes, SKILLS.restoration, SKILLS.ankh], items: [], attackCooldown: 2500 },
