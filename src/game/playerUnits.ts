...
export const UNIT_DATA: Record<number, UnitData> = {
    ...
    4: { name: "Wizard", class: "Wizard", hp: 17, maxHp: 17, mana: 45, maxMana: 45, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.fireball, SKILLS.chainLightning, SKILLS.magicWave, SKILLS.glacialWhorl, SKILLS.energyShield, SKILLS.bodySwap, SKILLS.teleportOther], items: [], attackCooldown: 3000, baseCrit: 2 },
