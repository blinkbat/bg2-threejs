...
export const UNIT_DATA: Record<number, UnitData> = {
    1: { name: "Barbarian", class: "Barbarian", hp: 33, maxHp: 33, mana: 15, maxMana: 15, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.warcry, SKILLS.defiance, SKILLS.stunningBlow, SKILLS.bloodMark, SKILLS.summonAncestor, SKILLS.highlandDefense, SKILLS.cleave, SKILLS.intimidate], items: [], range: 1.95, attackCooldown: 2000, baseCrit: 3 },
    2: { name: "Paladin", class: "Paladin", hp: 32, maxHp: 32, mana: 19, maxMana: 19, damage: [1, 4], accuracy: 65, armor: 0, skills: [SKILLS.raiseShield, SKILLS.divineLattice, SKILLS.sanctuary, SKILLS.holyStrike, SKILLS.vanquishingLight, SKILLS.smite, SKILLS.layOnHands], items: [], range: 1.7, attackCooldown: 2500 },
    3: { name: "Thief", class: "Thief", hp: 20, maxHp: 20, mana: 17, maxMana: 17, damage: [1, 4], accuracy: 75, armor: 0, skills: [SKILLS.poisonDagger, SKILLS.targetHead, SKILLS.targetArm, SKILLS.targetLegs, SKILLS.caltrops, SKILLS.smokeBomb, SKILLS.dodge], items: [], attackCooldown: 1500, baseCrit: 5 },
    4: { name: "Wizard", class: "Wizard", hp: 17, maxHp: 17, mana: 45, maxMana: 45, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.fireball, SKILLS.chainLightning, SKILLS.magicWave, SKILLS.glacialWhorl, SKILLS.energyShield, SKILLS.bodySwap, SKILLS.teleportOther, SKILLS.wallOfFire], items: [], attackCooldown: 3000, baseCrit: 2 },
    5: { name: "Monk", class: "Monk", hp: 25, maxHp: 25, mana: 17, maxMana: 17, damage: [1, 4], accuracy: 70, armor: 0, skills: [SKILLS.flurryOfFists, SKILLS.forcePush, SKILLS.wellOfGravity, SKILLS.qiFocus, SKILLS.sunStance, SKILLS.pangolinStance, SKILLS.flyingKick, SKILLS.fivePointPalm, SKILLS.dimMak], items: [], attackCooldown: 1800 },
    6: { name: "Cleric", class: "Cleric", hp: 24, maxHp: 24, mana: 37, maxMana: 37, damage: [1, 4], accuracy: 60, armor: 0, skills: [SKILLS.heal, SKILLS.massHeal, SKILLS.cleanse, SKILLS.thunder, SKILLS.holyCross, SKILLS.vishasEyes, SKILLS.elorasGrasp, SKILLS.restoration, SKILLS.ankh, SKILLS.turnUndead], items: [], attackCooldown: 2500 },
